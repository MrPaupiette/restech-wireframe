      ...
      <section className={styles.hero}>
        ...
        >
          ...
          <p className={styles.heroSubtitle}>
            [Sous-titre résumant le périmètre : de la conception à la maintenance, Restech intervient sur les infrastructures électriques, d'éclairage et de fibre en Morbihan & Finistère]
          </p>
        </motion.div>
      </section>
          ...
          <motion.div className={styles.cardsGrid} variants={stagger}>
              ...
              <Link to="/expertises/reseaux-electriques-eclairage" className={styles.cardLink}>
                <Card>
                  ...
                  <div className={styles.cardBody}>
                    <span className={styles.tag}>Pilier principal</span>
                    <h2 className={styles.cardTitle}>Réseaux électriques & Éclairage public</h2>
                    <p className={styles.cardText}>
                      [Description ~60 mots — Branchement électrique, raccordement réseau, enfouissement de lignes aériennes HTA/BT pour Enedis et les collectivités. Installation et rénovation d'éclairage public LED, mise en lumière de patrimoine communal. Interventions en Morbihan et Finistère avec notre propre parc matériel (nacelles 18m, pelles, camions grue). — KW : éclairage public (4 400/mois), branchement électrique (1 900/mois), éclairage public led (210/mois), raccordement réseau électrique (110/mois)]
                    </p>
                    <ul className={styles.bulletList}>
                      <li>Branchement & raccordement Enedis</li>
                      <li>Éclairage public LED & rénovation</li>
                      <li>Enfouissement de réseaux aériens</li>
                    </ul>
                  </div>
                </Card>
              </Link>
              <div className={styles.cardCta}>
                <Button label="Découvrir cette expertise" href="/expertises/reseaux-electriques-eclairage" variant="primary" />
              </div>
            </AnimDiv>
            ...
            <AnimDiv>
              <Link to="/expertises/fibre-optique-maintenance" className={styles.cardLink}>
                <Card>
                  <Placeholder
                    text="Photo maintenance fibre optique — technicien avec soudeuse fibre dans un boîtier de raccordement ouvert, câbles colorés visibles, véhicule Restech en arrière-plan"
                    height="320px"
                  />
                  <div className={styles.cardBody}>
                    <span className={styles.tag}>Expertise complémentaire</span>
                    <h2 className={styles.cardTitle}>Fibre optique & Maintenance</h2>
                    <p className={styles.cardText}>
                      [Description ~50 mots — Maintenance préventive et curative des réseaux fibre optique déployés en Bretagne. Intervention sur les infrastructures FTTH : réparation de câbles, remplacement de boîtiers PBO/SRO, réflectométrie, astreinte. Un angle distinctif : nous assurons la maintenance, pas le déploiement — complémentaire à notre filiale sœur CAUM. — KW : maintenance fibre optique (40/mois)]
                    </p>
                    <ul className={styles.bulletList}>
                      <li>Maintenance préventive & curative</li>
                      <li>Réflectométrie & diagnostic</li>
                      <li>Astreinte fibre 24/7</li>
                    </ul>
                  </div>
                </Card>
              </Link>
              <div className={styles.cardCta}>
                <Button label="Découvrir cette expertise" href="/expertises/fibre-optique-maintenance" variant="primary" />
                <a
                  href="https://caum.fr"
                  target="_blank"
                  rel="noopener noreferrer"
                  className={styles.cardIntersite}
                >
        ...
        <div className="container" style={{ textAlign: 'center' }}>
          <AnimDiv>
            ...
            <p className={styles.ctaSubtitle}>
              [Texte CTA ~30 mots — Collectivité, syndicat d'énergie, opérateur ou entreprise : contactez Restech pour vos travaux de réseaux électriques, d'éclairage public ou de maintenance fibre en Morbihan et Finistère.]
            </p>
        ...
        <div className={styles.seoInner}>
          <AnimDiv>
            ...
            <p className={styles.seoText}>
              ...
              <Link to="/territoires/finistere">Finistère</Link>. L'entreprise intervient aussi en maintenance fibre optique sur les réseaux FTTH bretons. Avec ~40 collaborateurs et un parc matériel propre (nacelles, pelles, camions grue), Restech est l'interlocuteur local des communes de Vannes, Lorient, Quimper, Auray, Concarneau.{' '}
